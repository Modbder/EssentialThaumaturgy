...
public class ContainerMRUCrystalDestructor extends Container{
	
    private TileMRUCrystalDestructor in;

    public ContainerMRUCrystalDestructor(InventoryPlayer par1InventoryPlayer, TileEntity par2)
    {
        this.in = (TileMRUCrystalDestructor) par2;
        this.addSlotToContainer(new Slot(in, 0, 29, 32));
        this.addSlotToContainer(new Slot(in, 1, 29, 12));
        int i;
