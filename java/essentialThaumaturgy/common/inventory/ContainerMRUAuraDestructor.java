...
public class ContainerMRUAuraDestructor extends Container{
	
    private TileMRUAuraDestructor in;

    public ContainerMRUAuraDestructor(InventoryPlayer par1InventoryPlayer, TileEntity par2)
    {
        this.in = (TileMRUAuraDestructor) par2;
