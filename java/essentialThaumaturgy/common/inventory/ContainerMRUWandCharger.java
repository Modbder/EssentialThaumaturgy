...
public class ContainerMRUWandCharger extends Container{
	
    private TileMRUWandCharger in;

    public ContainerMRUWandCharger(InventoryPlayer par1InventoryPlayer, TileEntity par2)
    {
        this.in = (TileMRUWandCharger) par2;
