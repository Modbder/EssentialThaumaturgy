...
public class ContainerMRUCUAbsorber extends Container{
	
    private TileMRUCUAbsorber in;

    public ContainerMRUCUAbsorber(InventoryPlayer par1InventoryPlayer, TileEntity par2)
    {
        this.in = (TileMRUCUAbsorber) par2;
