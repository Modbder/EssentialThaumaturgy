...
public class ContainerFluxWiper extends Container{
	
    private TileFluxWiper in;

    public ContainerFluxWiper(InventoryPlayer par1InventoryPlayer, TileEntity par2)
    {
        this.in = (TileFluxWiper) par2;
