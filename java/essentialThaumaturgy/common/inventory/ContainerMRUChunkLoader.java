...
public class ContainerMRUChunkLoader extends Container{
	
    private TileMRUChunkLoader in;

    public ContainerMRUChunkLoader(InventoryPlayer par1InventoryPlayer, TileEntity par2)
    {
        this.in = (TileMRUChunkLoader) par2;
