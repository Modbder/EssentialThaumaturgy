...
public class ContainerMRUDimTranciever extends Container{
	
    private TileMRUDimensionalTranciever in;

    public ContainerMRUDimTranciever(InventoryPlayer par1InventoryPlayer, TileEntity par2)
    {
        this.in = (TileMRUDimensionalTranciever) par2;
