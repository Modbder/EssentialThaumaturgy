...
public class ContainerMRUSpreader extends Container{
	
    private TileMRUSpreader in;

    public ContainerMRUSpreader(InventoryPlayer par1InventoryPlayer, TileEntity par2)
    {
        this.in = (TileMRUSpreader) par2;
