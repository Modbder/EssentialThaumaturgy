...
public class BlockAuraStabiliser extends BlockContainer{

	public IIcon[] sidedIcon = new IIcon[3];
	
	public BlockAuraStabiliser()
	{
		super(Material.rock);
	}
	...
	protected BlockAuraStabiliser(Material p_i45386_1_) {
		super(p_i45386_1_);
	...
	public TileEntity createNewTileEntity(World p_149915_1_, int p_149915_2_) {
		...
		return new TileMRUAuraStabiliser();
	}
