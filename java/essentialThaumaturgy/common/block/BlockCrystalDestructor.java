...
public class BlockCrystalDestructor extends BlockContainer{

	public IIcon[] sidedIcon = new IIcon[3];
	
	public BlockCrystalDestructor()
	{
		super(Material.rock);
	}
	...
	protected BlockCrystalDestructor(Material p_i45386_1_) {
		super(p_i45386_1_);
	...
	public TileEntity createNewTileEntity(World p_149915_1_, int p_149915_2_) {
		...
		return new TileMRUCrystalDestructor();
	}
